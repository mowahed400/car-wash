                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="price.blade.php" class="nav-item nav-link">Price</a>
                            <a href="location.blade.php" class="nav-item nav-link">Washing Points</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu">
                                    <a href="blog.blade.php" class="dropdown-item">Blog Grid</a>
                                    <a href="single.blade.php" class="dropdown-item">Detail Page</a>
                                    <a href="team.blade.php" class="dropdown-item">Team Member</a>
                                    <a href="booking.blade.php" class="dropdown-item">Schedule Booking</a>
                                </div>
                            </div>
